...
function buildProjectContextBlock(projectRoot: string): string {
  return [
    ...
    '',
    'Default chain: resolve_project -> plan_context -> get_context_pack/search_code -> search_symbols -> find_definition/find_references -> impact_analysis -> get_related_tests.',
    '',
    ...
    '7. `remember_project_fact` - save durable architecture decisions or bug root causes.',
    '',
